...
ORDERED=(ubuntu-base docker-config api-config languages shell fisher git zerotier zellij browsers vms overleaf openclaw opencode codex claude-code hermes-agent paseo aris vibma skills)
